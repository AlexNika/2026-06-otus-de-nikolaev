# Домашнее задание №2 по уроку №2 "Docker"

## Регистрация аккаунта в облаке. Создание VM. Установка Docker.

## Цель:
В рамках этого ДЗ вам нужно зарегистрироваться в Yandex Cloud. Создать Linux VM. Установить в ней Docker. Запустить простой образ.
